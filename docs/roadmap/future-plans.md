...
| **Native mobile**, notification surface only | Measured drop-off between notification and first action that responsive web can't close |
...
| **Repeat projects** | 25% start something else within 14 days unprompted. The second project is where retention lives and nothing currently addresses it |

## Interesting but unjustified

Verified contribution records (needs someone who says they'd trust it) · employer matching (a different business, different sales motion) · peer-to-peer commissions (payments, disputes, moderation out of proportion) · non-English markets (a distribution decision, not translation) · an open template ecosystem (only once we know what a good template is).
...
- **Streaks and countdowns** — *will*-tense mechanics that produce compliance, not mastery ([D-004](../log/decision-log.md), [D-024](../log/decision-log.md))
- **Badges, trophies, collections** — *have*-tense, and things you have devalue ([D-024](../log/decision-log.md), [D-026](../log/decision-log.md))
...
- **A single universal confidence score, or any score of an internal state** ([D-009](../log/decision-log.md))
