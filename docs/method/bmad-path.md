...
- **Nothing cumulative on the home-screen surface.** Reject any story putting a count, total, streak, elapsed time, or record on it (`FR-054`). It is seen without being chosen, which is what makes a number there a demand rather than a record. Expect this one to be argued away by a reasonable-sounding request.
