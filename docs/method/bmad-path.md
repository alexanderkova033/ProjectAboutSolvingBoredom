...
2. **Five conversations with people who read applications** — hiring managers for the adult segment, admissions or sixth-form staff for persona D. Does a self-directed project change how they read a candidate? Everything downstream terminates in the artifact being worth something to someone who decides; it is asserted everywhere and tested nowhere.
